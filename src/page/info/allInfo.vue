 ...
 * @LastEditors: 关振俊
 * @LastEditTime: 2022-06-28 14:50:45
 * @Description: 信息
-->
<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column fixed="right" label="Operations">
                <template #default="scope">
                    <el-button size="small" @click="handleEdit(scope.row, scope.$index)">Edit</el-button>
        ...
        <el-drawer ref="drawerRef" v-model="showDialog" title="I have a nested form inside!" :before-close="handleClose"
            direction="ltr" custom-class="demo-drawer">
            <div class="demo-drawer__content">
                <el-form :model="form">
                    ...
                    <el-form-item label="时间" :label-width="formLabelWidth">
                        <el-date-picker v-model="form.date" type="date" label="Pick a date" placeholder="Pick a date"
                            style="width: 100%" />
                    </el-form-item>
...
const onClick = () => {
    ...
    currentNum.value === 0 ? tableData.push(formData) : tableData[currentNum.value] = formData
    cancelForm()
}
